...
> 	 * Sales users are not notified when saved carts are created.
> 	 * It is possible to edit a saved cart such that it becomes a quote, as explained in [Quote Details](#quote-details).
...
To change the app’s settings, access **Account Settings >** **Apps > My Apps** > **B2B Quotes & Carts** in the VTEX Admin.
